Title: O que há de novo no WebGL2
Description: O que há de novo no WebGL2

WebGL2 é uma atualização muito significativa do WebGL1.
Se você está vindo do WebGL1 e quer saber como
ajustar seu código para obter as vantagens do
WebGL2 [veja este artigo](webgl1-to-webgl2.html).

Aqui está uma lista curta sem uma ordem específica

## Objetos Vertex Array sempre disponíveis
