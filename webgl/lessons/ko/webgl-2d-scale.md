...
또 하나 주의해야 할 점은 0에서 크기 변환입니다. 우리가 그린 F에서 0은 왼쪽 위 코너입니다. 이는 위치에 크기를 곱하기 때문에 0을 항상 0으로 이동하게 만듭니다.
...
<p>
방향을 알수 있는 어떤 모양도 작동할 것입니다. 단지 아이디어가 'F'irst로 소개 되었기 때문에 'F'를 사용 했습니다.
</p>
</div>
